...
**Other files:** 
...*TreeDemo*: Demo program for the exercise on binary trees
...*TreeTest*: Examples of automatic tests program for the exercise on binary trees 
...*Makefile*: Bash script to execute the program with all of its classes
